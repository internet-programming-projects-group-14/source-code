export async function measureThroughput() {
  ...
  try {
    ...
    console.log("Expected size:", expectedSizeBytes, "bytes");
    console.log("Actual downloaded size:", downloadSize, "bytes");
    ...
    console.log("Time in seconds:", timeInSeconds.toFixed(3), "seconds");
    ...
    console.log("Calculated throughput:", throughputMbps.toFixed(2), "Mbps");
